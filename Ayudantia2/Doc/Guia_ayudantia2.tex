...
\end{figure}
\begin{center}
    {\LARGE \textbf{Ayudantía Nº2}}\\[0.3em]
    {\large Valoración de Futuros y Forwards}\\[0.8em]
    \textbf{Curso:} Instrumentos Derivados\\
    \textbf{Profesor:} Francisco Rantul\\
    \textbf{Ayudante:} Mateo Canales\\
    \textbf{Fecha:} 08/04/2026
\end{center}
\vspace{0.5em}
...
\begin{enumerate}[label=\textbf{\alph*)}]
    ...
    \item Suponga que existe una baja demanda por el commodity de plata, por lo tanto,
