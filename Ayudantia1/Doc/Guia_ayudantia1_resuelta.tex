...
\section*{\subrayadoRojo{Respuestas Caso 1}}
...
\end{quote}
\newpage
\section*{\subrayadoRojo{Respuestas Caso 2}}

\subsection*{g) Calcule la curva cero de 1 a 5 años.}

\subsection*{h) Grafique la curva cero.}

\subsection*{i) 
Comente la probabilidad de default aproximada usando el spread de la tabla}
